export const duaData = {
  "title": "Doa Memohon Kelonggaran (Kemudahan) dan Keampunan (Surah al-Baqarah: 286)",
  "fullArabic": `\
...
`,
  "fullTranslation": `\
• <span class="text-emerald-600">"Wahai Tuhan kami! Janganlah Engkau menghukum kami </span>\
• <span class="text-yellow-500">jika kami terlupa atau kami tersilap (salah tanpa sengaja). </span> \
• <span class="text-pink-600">Wahai Tuhan kami! Janganlah Engkau bebankan ke atas kami </span>\ \
• <span class="text-cyan-600">bebanan yang berat sebagaimana yang telah Engkau bebankan </span> \
• <span class="text-stone-600">ke atas orang-orangที่ terdahulu sebelum kami. </span> \
• <span class="text-blue-800">Wahai Tuhan kami! Janganlah Engkau pikulkan ke atas kami </span> \
• <span class="text-lime-500">apa yang tidak termampu oleh kami untuk memikulnya. </span> \
• <span class="text-fuchsia-600">Dan maafkanlah dosa kami, </span>\
• <span class="text-green-500">dan ampunkanlah kesilapan kami, </span>\
• <span class="text-amber-600">serta rahmatilah kami. </span>\
• <span class="text-gray-500">Engkaulah Pelindung (Penolong) kami; </span>\
• <span class="text-violet-600">oleh itu, tolonglah kami untuk mencapai kemenangan ke atas kaum yang kafir (ingkar)."</span> \
<span class="block text-right text-lg text-slate-500">(Surah al-Baqarah: 286)</span>
`,
  "explanation": `\
  Ia merupakan doa yang amat agung yang terletak pada ayat terakhir Surah al-Baqarah (ayat 286). Doa ini mengandungi permohonan kasih sayang dan rahmat Allah SWT agar tidak menghukum hamba-Nya atas kesilapan yang dilakukan kerana terlupa atau tidak sengaja. \
  Di samping itu, ia juga merupakan rayuan agar kita tidak dibebankan dengan ujian, syariat yang terlalu berat, atau musibah yang melampaui batas kemampuan fizikal dan mental untuk dipikul. \
...
"words": [
    ...
    { "ar": "أَوْ أَخْطَأْنَا", "read": "au akhto'na", "mean": "atau kami tersilap / tersalah (tanpa sengaja)" },
    { "ar": "رَبَّنَا", "read": "Rabbana", "mean": "Wahai Tuhan kami" },
    { "ar": "وَلَا تَحْمِلْ", "read": "wa la tahmil", "mean": "dan janganlah Engkau bebankan" },
    { "ar": "عَلَيْنَآ", "read": "'alaina", "mean": "ke atas kami" },
    { "ar": "إِصْرًۭา", "read": "isron", "mean": "bebanan yang berat / ikatan yang menyusahkan" },
    { "ar": "كَمَا", "read": "kama", "mean": "sebagaimana" },
    ...
    { "ar": "มَا", "read": "ma", "mean": "apa yang" },
    { "ar": "لَا طَاقَةَ", "read": "la toqata", "mean": "tiada kekuatan / tiada keupayaan" },
