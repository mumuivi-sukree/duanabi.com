export const duaData = {
  "title": "ดุอาอ์ขอให้ได้บุตรที่ดี (นบีซะกะรียา)",
"fullArabic": `\
...
`,
  ...
  "words": [
    ...
    { "ar": "هَبْ لِي", "read": "ฮับลี", "mean": "ขอพระองค์ทรงประทานแก่ข้าพระองค์" },
    { "ar": "مِن لَّدُنكَ", "read": "มิลละดุนกะ", "mean": "จากพระองค์ (จากความเมตตาของพระองค์)" },
    { "ar": "ذُرِّيَّةً", "read": "ซุรรียะตัน", "mean": "ซึ่งบุตร/สายสืบโลหิต" },
    { "ar": "طَيِّبَةً", "read": "ต็อยยิบะฮ์", "mean": "ที่ดี/ที่บริสุทธิ์" },
    { "ar": "إِنَّكَ", "read": "อินนะกะ", "mean": "แท้จริงพระองค์ท่าน" },
    { "ar": "سَمِيعُ", "read": "สะมีอุด", "mean": "เป็นผู้ทรงได้ยิน" },
    { "ar": "الدُّعَاءِ", "read": "ดุอาอ์", "mean": "การวิงวอน/คำขอพร" }
  ]
}